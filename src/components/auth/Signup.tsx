    ...
    <div className="min-w-screen min-h-screen flex justify-center items-center">
      ...
      <div className='w-1/2'>
        <div className='p-12 max-w-xl border-0.5 rounded-lg shadow-lg'>
          <Typography text="Create an account" variant="text-4xl font-semibold mb-1" />
          <Typography text="Please fill in the form below to create an account." variant="text-lg mb-12" />
          ...
          <Button text="Sign Up" onClick={() => { }} variant="my-4" />
