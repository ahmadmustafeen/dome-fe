...
const CreateNewClientCard = ({ onClick }: { onClick: () => void }) => {
  return (
    <div className='border-2 group cursor-pointer hover:bg-primary transition-all duration-500 hover:scale-[105%] rounded-xl py-10 w-1/2 md:w-[32.2%] lg:w-[30%] bg-transparent flex justify-center items-center flex-col' onClick={onClick} >
