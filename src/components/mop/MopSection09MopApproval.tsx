...
const patchReviewRow = (
  ...
  id: string,
  partial: Partial<Pick<MopApprovalReviewRow, "reviewersName" | "reviewersTitle" | "date">>,
          ...
          <tbody>
            {reviewRows.map((row) => (
              <tr key={row.id} className="bg-white">
                <td className="border border-gray-200 px-2 py-2 align-top font-semibold text-gray-900">
                  {row.reviewStage}
                </td>
                ...
                <td className="border border-gray-200 px-2 py-1 align-top">
                  <Input
                    ...
                    aria-label={`${row.reviewStage} ${MOP_SECTION_09_TABLE_HEADERS.date}`}
                  />
                </td>
              </tr>
            ))}
