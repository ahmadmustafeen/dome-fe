...
export const newMopReferencePolicyRow = (): MopReferencePolicyRow => ({
  id: newMopRowId('pol'),
  policyDocument: '',
  uploadDate: '',
  type: 'Company Policy',
...
export const newMopReferenceLinkRow = (): MopReferenceLinkRow => ({
  id: newMopRowId('ref'),
  title: '',
  type: '',
  linkUrl: '',
...
export const newMopReferenceSafetyRow = (): MopReferenceSafetyRow => ({
  id: newMopRowId('sft'),
  safetyStandard: '',
  authority: '',
  linkUrl: '',
...
const fillPolicyRows = (count: number): MopReferencePolicyRow[] =>
  Array.from({ length: count }, () => newMopReferencePolicyRow());

const fillLinkRows = (count: number): MopReferenceLinkRow[] =>
  Array.from({ length: count }, () => newMopReferenceLinkRow());
